...
export const BOOKMARKS: Bookmark[] = [
  {
    ...
    description:
      "Your journey to mastery. Essential reading for every software engineer.",
  ...
  },
  {
    ...
    href: "https://aurorascharff.no/posts/component-architecture-for-react-server-components",
    author: "Aurora Scharff",
    bookmarkedAt: "2026-05-30",
  },
  {
    title: "Details that make interfaces feel better",
    href: "https://interfaces.dev/magazine/issues/details-that-make-interfaces-feel-better",
    author: "Jakub Krehel",
    bookmarkedAt: "2026-06-05",
  },
  {
    title: "A Clock That Doesn’t Snap",
    href: "https://ethanniser.dev/blog/a-clock-that-doesnt-snap/",
    author: "Ethan Niser",
